...
const Accessories: React.FC = () => {
  ...
  useEffect(() => {
    const fetchBrandsAndModels = () => {
      const brandsData: Brand[] = [
        {
          brand: "Sony",
          models: ["WH-1000XM4", "QuietComfort 35 II", "AirPods Pro", "HD 660 S", "JBL Free X"],
        },
        {
          brand: "Anker",
          models: ["PowerPort", "PowerCore 26800mAh", "PowerCore 10000mAh"],
        },
        {
          brand: "Apple",
          models: ["20W USB-C Power Adapter", "Magic Keyboard", "AirPods"],
        },
        {
          brand: "Logitech",
          models: ["MX Master 3", "Wireless Keyboard", "Wireless Mouse"],
        },
        {
          brand: "Samsung",
          models: ["Super Fast Charger", "Wireless Charger Portable Battery"],
        },
        {
          brand: "Other",
          models: ["Super Fast Charger", "Wireless Charger Portable Battery"],
  ...
  return (
    <div className="container mx-auto p-8">
      <ToastContainer />
      <h1 className="text-4xl font-bold mb-6 p-6 text-center">Accessories Recycling Request Form</h1>
      <form
      ...
      >
        ...
        <div className="mb-4" style={{ height: '1cm' }}>
          ...
          <input
            ...
            placeholder="ex:Earphone,charger,speaker,etc"
            required
          />
        </div>
